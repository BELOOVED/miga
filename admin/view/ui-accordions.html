...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      ...
      <h6 class="text-uppercase">Accordions</h6>
    <hr>
      <div class="row">
        <div class="col-lg-6">
          <div id="accordion1">
              <div class="card mb-2">
                <div class="card-header">
                    <button class="btn btn-link text-white shadow-none" data-toggle="collapse" data-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1">
              ...
              <div class="card mb-2">
                <div class="card-header">
                    <button class="btn btn-link text-white shadow-none collapsed" data-toggle="collapse" data-target="#collapse-2" aria-expanded="false" aria-controls="collapse-2">
              ...
              <div class="card">
                <div class="card-header">
                    <button class="btn btn-link text-white shadow-none collapsed" data-toggle="collapse" data-target="#collapse-3" aria-expanded="false" aria-controls="collapse-3">
        ...
        <div class="col-lg-6">
          <div id="accordion2">
              <div class="card mb-2">
                <div class="card-header">
                    <button class="btn btn-link shadow-none text-white" data-toggle="collapse" data-target="#collapse-4" aria-expanded="true" aria-controls="collapse-4">
                      Accordion Group Item #1
                    </button>
                </div>

                <div id="collapse-4" class="collapse show" data-parent="#accordion2">
                  <div class="card-body">
                    <div class="card-title text-uppercase">Some title example here</div>
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et.
                  </div>
              ...
              <div class="card mb-2">
                <div class="card-header">
                    <button class="btn btn-link shadow-none text-white collapsed" data-toggle="collapse" data-target="#collapse-5" aria-expanded="false" aria-controls="collapse-5">
                      Accordion Group Item #2
                    </button>
                </div>
                <div id="collapse-5" class="collapse" data-parent="#accordion2">
                  <div class="card-body">
                    <div class="card-title text-uppercase">Some title example here</div>
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et.
                  </div>
              ...
              <div class="card">
                <div class="card-header">
                    <button class="btn btn-link shadow-none text-white collapsed" data-toggle="collapse" data-target="#collapse-6" aria-expanded="false" aria-controls="collapse-6">
                      Accordion Group Item #3
                    </button>
                </div>
    ...
    <h6 class="text-uppercase">Color Accordion</h6>
    <hr>
    <div class="row">
        <div class="col-lg-6">
          <div id="accordion3">
              <div class="card mb-2">
                ...
                <div id="collapse-7" class="collapse show" data-parent="#accordion3">
                  <div class="card-body">
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et.
                  </div>
                </div>
              ...
              <div class="card mb-2">
                <div class="card-header bg-warning">
                    <button class="btn btn-link text-white shadow-none collapsed" data-toggle="collapse" data-target="#collapse-8" aria-expanded="false" aria-controls="collapse-8">
                      Accordion Group Item #2
                    </button>
                </div>
                <div id="collapse-8" class="collapse" data-parent="#accordion3">
                  <div class="card-body">
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et.
                  </div>
                </div>
              ...
              <div class="card">
                <div class="card-header bg-info">
                    <button class="btn btn-link text-white shadow-none collapsed" data-toggle="collapse" data-target="#collapse-9" aria-expanded="false" aria-controls="collapse-9">
                      Accordion Group Item #3
                    </button>
                </div>
                <div id="collapse-9" class="collapse" data-parent="#accordion3">
                  <div class="card-body">
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                  </div>
                </div>
          ...
          <div id="accordion4">
              <div class="card mb-2">
                <div class="card-header bg-secondary">
                    <button class="btn btn-link shadow-none text-white" data-toggle="collapse" data-target="#collapse-10" aria-expanded="true" aria-controls="collapse-10">
                      Accordion Group Item #1
                    </button>
                </div>

                <div id="collapse-10" class="collapse show" data-parent="#accordion4">
                  <div class="card-body">
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et.
                  </div>
                </div>
              ...
              <div class="card mb-2">
                <div class="card-header bg-danger">
                    <button class="btn btn-link shadow-none text-white collapsed" data-toggle="collapse" data-target="#collapse-11" aria-expanded="false" aria-controls="collapse-11">
                      Accordion Group Item #2
                    </button>
                </div>
                <div id="collapse-11" class="collapse" data-parent="#accordion4">
                  <div class="card-body">
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et.
                  </div>
                </div>
              ...
              <div class="card">
                <div class="card-header bg-primary">
                    <button class="btn btn-link shadow-none text-white collapsed" data-toggle="collapse" data-target="#collapse-12" aria-expanded="false" aria-controls="collapse-12">
                      Accordion Group Item #3
                    </button>
                </div>
                <div id="collapse-12" class="collapse" data-parent="#accordion4">
                  <div class="card-body">
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                  </div>
                </div>
       ...
       <h6 class="text-uppercase">Accordion with Background Color</h6>
       <hr>
       <div class="row">
        <div class="col-lg-12">
          <div id="accordion6">
              <div class="card mb-2 bg-success">
                <div class="card-header bg-transparent border-light-2">
                    <button class="btn btn-link shadow-none text-white" data-toggle="collapse" data-target="#collapse-16" aria-expanded="true" aria-controls="collapse-16">
                      Accordion with Background Color #1
                    </button>
                </div>

                <div id="collapse-16" class="collapse show" data-parent="#accordion6">
              ...
              <div class="card mb-2 bg-danger">
                <div class="card-header bg-transparent border-light-2">
                    <button class="btn btn-link shadow-none text-white collapsed" data-toggle="collapse" data-target="#collapse-17" aria-expanded="false" aria-controls="collapse-17">
                      Accordion with Background Color #2
                    </button>
                </div>
                <div id="collapse-17" class="collapse" data-parent="#accordion6">
                  <div class="card-body text-white">
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                  </div>
                </div>
              ...
              <div class="card bg-primary">
                <div class="card-header bg-transparent border-light-2">
                    <button class="btn btn-link shadow-none text-white collapsed" data-toggle="collapse" data-target="#collapse-18" aria-expanded="false" aria-controls="collapse-18">
                      Accordion with Background Color #3
                    </button>
                </div>
                <div id="collapse-18" class="collapse" data-parent="#accordion6">
                  <div class="card-body text-white">
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                  </div>
                </div>
    ...
    <h6 class="text-uppercase">Accordion with Outline</h6>
    <hr>
      <div class="row">
        <div class="col-lg-12">
          <div id="accordion8">
              ...
              <div class="card mb-2 border border-danger">
                <div class="card-header">
                    <button class="btn btn-link shadow-none text-danger collapsed" data-toggle="collapse" data-target="#collapse-23" aria-expanded="false" aria-controls="collapse-23">
                      Accordion Group Item #2
                    </button>
                </div>
                <div id="collapse-23" class="collapse" data-parent="#accordion8">
                  <div class="card-body">
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                  </div>
                </div>
              ...
              <div class="card border border-primary">
                <div class="card-header">
                    <button class="btn btn-link shadow-none text-primary collapsed" data-toggle="collapse" data-target="#collapse-24" aria-expanded="false" aria-controls="collapse-24">
                      Accordion Group Item #3
                    </button>
                </div>
                <div id="collapse-24" class="collapse" data-parent="#accordion8">
                  <div class="card-body">
                    Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3 wolf moon tempor, sunt aliqua put a bird on it squid single-origin coffee nulla assumenda shoreditch et. Nihil anim keffiyeh helvetica, craft beer labore wes anderson cred nesciunt sapiente ea proident. Ad vegan excepteur butcher vice lomo. Leggings occaecat craft beer farm-to-table, raw denim aesthetic synth nesciunt you probably haven't heard of them accusamus labore sustainable VHS.
                  </div>
                </div>
