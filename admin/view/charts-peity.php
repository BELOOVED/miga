...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
	...
	<div class="card">
	 ...
	 <div class="card-body">
	    <div class="row text-center row-group m-0">
	  <div class="col-12 col-lg-4 col-xl-4">
	    <div class="card shadow-none bg-transparent">
            <div class="card-body">
			  <span class="pie" data-peity='{ "fill": ["#ffffff", "rgba(255, 255, 255, 0.14)"]}'>1/5</span>
                      <p class="my-2">Data : 1/5</p>
			</div>
		</div>
	  </div>
	  <div class="col-12 col-lg-4 col-xl-4">
	    <div class="card shadow-none bg-transparent">
            <div class="card-body">
			 <span class="pie" data-peity='{ "fill": ["#ffffff", "rgba(255, 255, 255, 0.14)"]}'>226/360</span>
                      <p class="my-2">Data : 226/360</p>
			</div>
		</div>
	  </div>
	  <div class="col-12 col-lg-4 col-xl-4">
	    <div class="card shadow-none bg-transparent">
            <div class="card-body">
			  <span class="pie" data-peity='{ "fill": ["#ffffff", "rgba(255, 255, 255, 0.14)"]}'>0.52/1.561</span>
                      <p class="my-2">Data : 0.52/1.561</p>
			</div>
		</div>
	  </div>
	  <div class="col-12 col-lg-4 col-xl-4">
	    <div class="card shadow-none bg-transparent">
            <div class="card-body">
			  <span class="pie" data-peity='{ "fill": ["#ffffff", "rgba(255, 255, 255, 0.14)"]}'>1,4</span>
                      <p class="my-2">Data : 1,4</p>
			</div>
		</div>
	  </div>
	  <div class="col-12 col-lg-4 col-xl-4">
	    <div class="card shadow-none bg-transparent">
            <div class="card-body">
			  <span class="pie" data-peity='{ "fill": ["#ffffff", "rgba(255, 255, 255, 0.14)"]}'>226,134</span>
                      <p class="my-2">Data : 226,134</p>
			</div>
		</div>
	  </div>
	  <div class="col-12 col-lg-4 col-xl-4">
	    <div class="card shadow-none bg-transparent">
            <div class="card-body">
			  <span class="pie" data-peity='{ "fill": ["#ffffff", "rgba(255, 255, 255, 0.14)"]}'>0.52,1.041</span>
                      <p class="my-2">Data : 0.52, 1.041</p>
			</div>
		</div>
	  </div>
	</div><!--End row-->
	...
	<div class="card">
	  <div class="card-header text-uppercase">Donut Chart</div>
	    <div class="card-body">
	      <div class="row text-center row-group m-0">
	  <div class="col-12 col-lg-4 col-xl-4">
	    <div class="card shadow-none bg-transparent">
            <div class="card-body">
			              <span class="donut" data-peity='{ "fill": ["#ffffff", "rgba(255, 255, 255, 0.14)"]}'>1/5</span>
                      <p class="my-2">Data : 1/5</p>
			</div>
		</div>
	  </div>
	  <div class="col-12 col-lg-4 col-xl-4">
	    <div class="card shadow-none bg-transparent">
            <div class="card-body">
			 <span class="donut" data-peity='{ "fill": ["#ffffff", "rgba(255, 255, 255, 0.14)"]}'>226/360</span>
                      <p class="my-2">Data : 226/360</p>
			</div>
		</div>
	  </div>
	  <div class="col-12 col-lg-4 col-xl-4">
	    <div class="card shadow-none bg-transparent">
            <div class="card-body">
			  <span class="donut" data-peity='{ "fill": ["#ffffff", "rgba(255, 255, 255, 0.14)"]}'>0.52/1.561</span>
                      <p class="my-2">Data : 0.52/1.561</p>
			</div>
		</div>
	  </div>
	  <div class="col-12 col-lg-4 col-xl-4">
	    <div class="card shadow-none bg-transparent">
            <div class="card-body">
			  <span class="donut" data-peity='{ "fill": ["#ffffff", "rgba(255, 255, 255, 0.14)"]}'>1,4</span>
                      <p class="my-2">Data : 1,4</p>
			</div>
		</div>
	  </div>
	  <div class="col-12 col-lg-4 col-xl-4">
	    <div class="card shadow-none bg-transparent">
            <div class="card-body">
			  <span class="donut" data-peity='{ "fill": ["#ffffff", "rgba(255, 255, 255, 0.14)"]}'>226,134</span>
                      <p class="my-2">Data : 226,134</p>
			</div>
		</div>
	  </div>
	  <div class="col-12 col-lg-4 col-xl-4">
	    <div class="card shadow-none bg-transparent">
            <div class="card-body">
			  <span class="donut" data-peity='{ "fill": ["#ffffff", "rgba(255, 255, 255, 0.14)"]}'>0.52,1.041</span>
                      <p class="my-2">Data : 0.52, 1.041</p>
			</div>
		</div>
	  </div>
	...
	<div class="card">
	  ...
	  <div class="col-12 col-lg-4 col-xl-4">
	   <div class="card shadow-none bg-transparent mb-0">
         <div class="card-body">
		    <span class="peity-bar" data-peity='{ "fill": ["#ffffff", "rgba(255, 255, 255, 0.14)"]}' data-width="100%" data-height="100">10,12,8,10,13,18,11,13,16,15,19,12,18,11,14,18,9,18,12,11</span>
		 </div>
		</div>
	  </div>
	  <div class="col-12 col-lg-4 col-xl-4">
	     <div class="card shadow-none bg-transparent mb-0">
         <div class="card-body">
		   <span class="peity-bar" data-peity='{ "fill": ["#ffffff", "rgba(255, 255, 255, 0.14)"]}' data-width="100%" data-height="100">6,2,8,4,-3,8,1,-3,6,-5,9,2,-8,1,4,8,9,8,2,1</span>
		 </div>
		</div>
	  </div>
	  <div class="col-12 col-lg-4 col-xl-4">
	...
	<div class="card">
	  ...
	  <div class="col-12 col-lg-4 col-xl-4">
	   <div class="card shadow-none bg-transparent mb-0">
         <div class="card-body">
		    <span class="peity-line" data-peity='{ "fill":"rgba(255, 255, 255, 0.54)", "stroke": "#ffffff", "strokeWidth": "0" }' data-width="100%" data-height="100">6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span>
		 </div>
		</div>
	  </div>
	  <div class="col-12 col-lg-4 col-xl-4">
	     <div class="card shadow-none bg-transparent mb-0">
         <div class="card-body">
		   <span class="peity-line" data-peity='{ "fill":"rgba(255, 255, 255, 0.54)", "stroke": "#ffffff", "strokeWidth": "0" }' data-width="100%" bg-color="#fff" data-height="100">6,2,8,4,-3,8,1,-3,6,-5,9,2,-8,1,4,8,9,8,2,1</span>
		 </div>
		</div>
	  </div>
	  <div class="col-12 col-lg-4 col-xl-4">
