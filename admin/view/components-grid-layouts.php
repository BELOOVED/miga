  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Grid Layouts</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Dashtreme</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">Components</a></li>
            <li class="breadcrumb-item active" aria-current="page">Grid Layouts</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header text-uppercase">Grid Options</div>
             <div class="card-body">
      ...
      <div class="row">
        <div class="col-lg-12">
           <div class="card">
            <div class="card-header text-uppercase">Grid Example</div>
             <div class="card-body">
                <div class="table-responsive">
                  <table class="grid">
                  <tbody><tr>
                  ...
                  <tr>
                    <td colspan="4">&nbsp;col-lg-4</td>
                    <td colspan="4">&nbsp;col-lg-4</td>  
                    <td colspan="4">&nbsp;col-lg-4</td>
                  </tr>
                  <tr>
                    <td colspan="4">col-lg-4</td>
                    <td colspan="8">col-lg-8</td>  
                  </tr>
                  <tr>
                    <td colspan="6">col-lg-6</td>
                    <td colspan="6">col-lg-6</td>  
                  </tr>
                  <tr>
                    <td colspan="12">col-lg-12</td>
                  </tr>
                  </tbody></table>
                  </div>
             </div>
