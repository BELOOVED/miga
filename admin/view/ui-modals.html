     ...
     <div class="card">
       <div class="card-body">
         <div class="row">
           <div class="col-lg-4">
         <!-- Default Size Modal -->
              <button class="btn btn-light btn-block m-1" data-toggle="modal" data-target="#imagemodal">Modal with image</button>
              <!-- Modal -->
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-light"><i class="fa fa-check-square-o"></i> Save changes</button>
                      </div>
                    </div>
                  </div>
                </div>
       ...
       <div class="col-lg-4">
         <!-- Large Size Modal -->
              <button class="btn btn-light btn-block m-1" data-toggle="modal" data-target="#formemodal">Modal with form</button>
              <!-- Modal -->
       ...
       <div class="col-lg-4">
         <!-- Small Size Modal -->
              <button class="btn btn-light btn-block m-1" data-toggle="modal" data-target="#cardmodal">Modal with BS Card</button>
              <!-- Modal -->
              ...
              <table class="table"> 
                ...
                <tbody> 
                    <tr> 
                        ...
                        <td> 
                           <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-target="#modal-animation-1">SHOW ME</button>
                          </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">animated rollIn</td> 
                        <td> 
                             <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-target="#modal-animation-2">SHOW ME</button>
                         </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">animated zoomInUp</td> 
                        <td> 
                             <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-target="#modal-animation-3">SHOW ME</button>
                         </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">animated slideInUp</td> 
                        <td> 
                           <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-target="#modal-animation-4">SHOW ME</button>
                       </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">animated rotateIn</td> 
                        <td> 
                           <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-target="#modal-animation-5">SHOW ME</button>
                       </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">animated flip</td> 
                        <td> 
                            <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-target="#modal-animation-6">SHOW ME</button>
                        </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">animated lightSpeedIn</td> 
                        <td> 
                           <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-target="#modal-animation-7">SHOW ME</button>
                       </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">animated swing</td> 
                        <td> 
                             <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-target="#modal-animation-8">SHOW ME</button>
                         </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">animated wobble</td> 
                        <td> 
                             <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-target="#modal-animation-9">SHOW ME</button>
                         </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">animated bounceIn</td> 
                        <td> 
                            <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-target="#modal-animation-10">SHOW ME</button>
                        </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">animated tada</td> 
                        <td> 
                            <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-target="#modal-animation-11">SHOW ME</button>
                        </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">animated jackInTheBox</td> 
                        <td> 
                            <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-target="#modal-animation-12">SHOW ME</button>
                        </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">animated flash</td> 
                        <td> 
                           <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-target="#modal-animation-13">SHOW ME</button>
                       </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">animated fadeInUp</td> 
                        <td> 
                             <button type="button" class="btn btn-light waves-effect waves-light" data-toggle="modal" data-target="#modal-animation-14">SHOW ME</button>
                         </td> 
                    </tr> 
                </tbody> 
            </table>
