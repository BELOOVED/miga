  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header text-uppercase">Sweet Alerts</div>
            <div class="card-body">
              <table class="table"> 
                <thead> 
                    <tr> 
                ...
                <tbody> 
                    <tr> 
                        ...
                        <td> 
                            <button type="button" class="btn btn-info waves-effect waves-light btn-sm" id="alert-basic">Click me</button>
                        </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">A title with a text under</td> 
                        <td> 
                            <button type="button" class="btn btn-info waves-effect waves-light btn-sm" id="alert-title">Click me</button>
                        </td> 
                    </tr> 
                    <tr> 
                        <td class="middle-align">A success message!</td> 
                        <td> 
                            <button type="button" class="btn btn-success waves-effect waves-light btn-sm" id="alert-success">Click me</button>
                        </td> 
                    </tr> 

                    <tr> 
                        <td class="middle-align">A Error message!</td> 
                        <td> 
                            <button type="button" class="btn btn-danger waves-effect waves-light btn-sm" id="alert-error">Click me</button>
                        </td> 
                    </tr> 

                    <tr> 
                        <td class="middle-align">A Info message!</td> 
                        <td> 
                            <button type="button" class="btn btn-info waves-effect waves-light btn-sm" id="alert-info">Click me</button>
                        </td> 
                    </tr> 

                    <tr> 
                        <td class="middle-align">A Warning message!</td> 
                        <td> 
                            <button type="button" class="btn btn-warning waves-effect waves-light btn-sm" id="alert-warning">Click me</button>
                        </td> 
                    </tr> 
                   
                    <tr> 
                        <td class="middle-align">A warning message, with a  "Confirm"-button...</td> 
                        <td> 
