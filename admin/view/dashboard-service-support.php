...
<head>
	...
	<title>Dashtreme - Multipurpose Bootstrap4 Admin Template</title><!--favicon-->
	<link href="assets/images/favicon.ico" rel="icon" type="image/x-icon"><!-- simplebar CSS-->
	<link href="assets/plugins/simplebar/css/simplebar.css" rel="stylesheet"><!-- Bootstrap core CSS-->
	<link href="assets/css/bootstrap.min.css" rel="stylesheet"><!-- animate CSS-->
	<link href="assets/css/animate.css" rel="stylesheet" type="text/css"><!-- Icons CSS-->
	<link href="assets/css/icons.css" rel="stylesheet" type="text/css"><!-- Sidebar CSS-->
	<link href="assets/css/sidebar-menu.css" rel="stylesheet"><!-- Custom Style-->
	<link href="assets/css/app-style.css" rel="stylesheet">
</head>
<body class="bg-theme bg-theme1">
	<!-- start loader -->
	<div class="visible incoming" id="pageloader-overlay">
   ...
   <!--End sidebar-wrapper-->
		...
		<header class="topbar-nav">
			<nav class="navbar navbar-expand fixed-top">
				...
				<ul class="navbar-nav align-items-center right-nav-link">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<ul class="list-group list-group-flush">
								...
								<li class="list-group-item">
									...
									<div class="media">
										<div class="avatar"><img alt="user avatar" class="align-self-start mr-3" src="https://via.placeholder.com/110x110"></div>
										<div class="media-body">
					...
					<li class="nav-item">
						<a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#"><span class="user-profile"><img alt="user avatar" class="img-circle" src="https://via.placeholder.com/110x110"></span></a>
						<ul class="dropdown-menu dropdown-menu-right">
							...
							<div class="card-body">
								<div class="media align-items-center">
									...
									<div class="media-body ml-3 border-left-xs border-light-3">
										...
										<p class="mb-0 ml-3 extra-small-font">Requests Answered</p>
									</div>
								</div>
							</div>
						</div>
		...
		<a class="back-to-top" href="javaScript:void();"><i class="fa fa-angle-double-up"></i></a> <!--End Back To Top Button-->
		 <!--Start footer-->
		<footer class="footer">
			<div class="container">
				<div class="text-center">
	...
	<script src="assets/plugins/simplebar/js/simplebar.js">
	</script> <!-- sidebar-menu js -->
	 
	<script src="assets/js/sidebar-menu.js">
	</script> <!-- Custom scripts -->
	 
	<script src="assets/js/app-script.js">
	</script> <!-- Chart js -->
	...
	<script src="assets/js/dashboard-service-support.js">
	</script>
</body>
</html>