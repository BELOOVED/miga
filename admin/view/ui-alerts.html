...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
	   ...
	   <div class="card">
		  <div class="card-header text-uppercase">Basic Alerts</div>
		  <div class="card-body">
		  ...
		  <div class="alert alert-info alert-dismissible" role="alert">
		   <button type="button" class="close" data-dismiss="alert">&times;</button>
			...
			<div class="alert-message">
			  <span><strong>Info!</strong> This is an info alert—check it out!</span>
			</div>
		  </div>
		  ...
		  <div class="alert alert-warning alert-dismissible mb-0" role="alert">
		   <button type="button" class="close" data-dismiss="alert">&times;</button>
			...
			<div class="alert-message">
			  <span><strong>Warning!</strong> This is an error alert—check it out!</span>
			</div>
		  </div>
		  </div>
		</div>
		...
		<div class="card">
		  <div class="card-header text-uppercase">Contrasts Alerts</div>
		  <div class="card-body">
		    <div class="alert alert-success alert-dismissible" role="alert">
			<button type="button" class="close" data-dismiss="alert">&times;</button>
		...
		<div class="card">
		  <div class="card-header text-uppercase">Outline Alerts</div>
		  <div class="card-body">
			...
			<div class="alert-message">
			  <span><strong>Success!</strong> Lorem Ipsum is <a href="javascript:void();" class="alert-link">simply dummy text.</a></span>
			</div>
		  </div>
		  ...
		  <div class="alert alert-outline-info alert-dismissible" role="alert">
		   <button type="button" class="close" data-dismiss="alert">&times;</button>
			...
			<div class="alert-message">
			  <span><strong>Info!</strong> Lorem Ipsum is <a href="javascript:void();" class="alert-link">simply dummy text.</a></span>
			</div>
		  </div>
		  ...
		  <div class="alert alert-outline-danger alert-dismissible" role="alert">
		   <button type="button" class="close" data-dismiss="alert">&times;</button>
			...
			<div class="alert-message">
			  <span><strong>Danger!</strong> Lorem Ipsum is <a href="javascript:void();" class="alert-link">simply dummy text.</a></span>
			</div>
		  </div>
		  ...
		  <div class="alert alert-outline-warning alert-dismissible mb-0" role="alert">
		   <button type="button" class="close" data-dismiss="alert">&times;</button>
			...
			<div class="alert-message">
			  <span><strong>Warning!</strong> Lorem Ipsum is <a href="javascript:void();" class="alert-link">simply dummy text.</a></span>
			</div>
		  </div>
		  </div>
		</div>
		...
		<div class="card">
		  <div class="card-header text-uppercase">Section Icon Alerts</div>
		  <div class="card-body">
