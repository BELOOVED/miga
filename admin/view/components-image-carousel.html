  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Image Carousel</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javaScript:void();">Dashtreme</a></li>
            <li class="breadcrumb-item"><a href="javaScript:void();">Components</a></li>
            <li class="breadcrumb-item active" aria-current="page">Image Carousel</li>
         </ol>
	   </div>
	   <div class="col-sm-3">
    ...
    <!-- End Breadcrumb-->
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="card">
            <div class="card-header text-uppercase">Simple Carousel</div>
             <div class="card-body">
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-header text-uppercase">Carousel With controls</div>
             <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-header text-uppercase">Carousel With captions</div>
             <div class="card-body">
               <div id="carousel-4" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img class="d-block w-100" src="https://via.placeholder.com/1920x1080" alt="Los Angeles">
                    ...
                    <div class="carousel-item">
                      <img class="d-block w-100" src="https://via.placeholder.com/1920x1080" alt="Chicago">
                      <div class="carousel-caption">
                    ...
                    <div class="carousel-item">
                      <img class="d-block w-100" src="https://via.placeholder.com/1920x1080" alt="New York">
                      <div class="carousel-caption">
