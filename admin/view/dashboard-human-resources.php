      ...
      <div class="row mt-3">
       <div class="col-12 col-lg-12 col-xl-6">
        <div class="card-deck flex-column flex-xl-row">
           <div class="card">
            <div class="card-body">
              <div class=""><i class="zmdi zmdi-accounts-alt text-white font-33"></i></div>
              <h3 class="mb-0 mt-2">928</h3>
            ...
            <div class="card">
            <div class="card-body">
              <div class=""><i class="zmdi zmdi-money text-white font-33"></i></div>
              <h3 class="mb-0 mt-2">$20.2K</h3>
        ...
        <div class="card-deck flex-column flex-xl-row">
          <div class="card">
          <div class="card-body">
              <div class=""><i class="zmdi zmdi-camera text-white font-33"></i></div>
              <h3 class="mb-0 mt-2">32</h3>
          ...
          <div class="card">
          <div class="card-body">
              <div class=""><i class="zmdi zmdi-face text-white font-33"></i></div>
              <h3 class="mb-0 mt-2">14</h3>
