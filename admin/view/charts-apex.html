    ...
    <!-- End Breadcrumb-->
      ...
      <div class="row">
        <div class="col-12 col-lg-12 col-xl-12">
          ...
          <div class="card">
            <div class="card-header text-uppercase">Column Chart</div>
			   <div class="card-body">
				   <div id="chart3"></div>
			   </div>  
          </div>
	  ...
	  <div class="row">
        <div class="col-12 col-lg-6 col-xl-6">
          <div class="card">
            <div class="card-header text-uppercase">Radar Chart</div>
             <div class="card-body">
               <div id="chart6"></div>
           </div>  
          </div>
        ...
        <div class="col-12 col-lg-6 col-xl-6">
          <div class="card">
            <div class="card-header text-uppercase">Radialbar Chart</div>
             <div class="card-body">
               <div id="chart7"></div>
           </div>  
          </div>
        ...
        <div class="col-12 col-lg-6 col-xl-6">
          <div class="card">
            <div class="card-header text-uppercase">Circle Chart</div>
             <div class="card-body">
               <div id="chart8"></div>
           </div>  
          </div>
        ...
        <div class="col-12 col-lg-6 col-xl-6">
          <div class="card">
            <div class="card-header text-uppercase">Stroked Gauge Chart</div>
             <div class="card-body">
               <div id="chart9"></div>
           </div>  
          </div>
...
<!--start overlay-->
  ...
  <script src="assets/plugins/apexcharts/apex-custom-script.js"></script>
