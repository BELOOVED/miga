  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-6">
          <div class="card">
            <div class="card-header text-uppercase">Default Pagination</div>
             <div class="card-body">
              ...
              <p>Disabled State</p>
              <ul class="pagination">
                <li class="page-item disabled"><a class="page-link" href="javascript:void();">Previous</a></li>
                <li class="page-item"><a class="page-link" href="javascript:void();">1</a></li>
                <li class="page-item"><a class="page-link" href="javascript:void();">2</a></li>
                <li class="page-item"><a class="page-link" href="javascript:void();">3</a></li>
                <li class="page-item"><a class="page-link" href="javascript:void();">Next</a></li>
		...
		<div class="col-lg-6">
          <div class="card">
            <div class="card-header text-uppercase">Round Pagination Style </div>
             <div class="card-body">
              ...
              <p>Large Pagination</p>
			  <div class="table-responsive">
              <ul class="pagination pagination-round pagination-lg">
                <li class="page-item"><a class="page-link" href="javascript:void();">Previous</a></li>
                <li class="page-item"><a class="page-link" href="javascript:void();">1</a></li>
                <li class="page-item"><a class="page-link" href="javascript:void();">2</a></li>
                <li class="page-item"><a class="page-link" href="javascript:void();">3</a></li>
		...
		<div class="row">
         <div class="col-lg-12">
		  <div class="card">
            <div class="card-header text-uppercase">Pagination in different styles </div>
             <div class="card-body">
