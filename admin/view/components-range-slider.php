  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
       <div class="row">
        <div class="col-lg-12">
          <div class="card">
             <div class="card-header text-uppercase">Range Slider</div>
             <div class="card-body">
                <label>Start without params</label>
                <input type="text" id="range_01" value="" name="range" />
                <hr>
                <label>Set min value, max value and start point</label>
                <input type="text" id="range_02" value="" name="range" />
                <hr>
                <label>Set type to double and specify range, also showing grid and adding prefix "$"</label>
                ...
                <hr>
                <label>Using step 250</label>
                <input type="text" id="range_05" value="" name="range" />
                <hr>
                <label>Set up range with fractional values, using fractional step</label>
                ...
                <hr>
                <label>One more example with strings</label>
                <input type="text" id="range_09" value="" name="range"/>
                <hr>
                <label>No prettify. Big numbers are ugly and unreadable</label>
                <input type="text" id="range_10" value="" name="range"/>
                <label>Prettify enabled. Much better!</label>
                <input type="text" id="range_11" value="" name="range"/>
                <hr>
                <label>Don't like space as separator? Use anything you like!</label>
                <input type="text" id="range_12" value="" name="range" />
                <hr>
                <label>You don't like default prettify function? Use your own!</label>
                <input type="text" id="range_13" value="" name="range"/>
                <hr>
                <label>Using prefixes</label>
                <input type="text" id="range_14" value="" name="range"/>
                <hr>
                <label>Using postfixes</label>
                <input type="text" id="range_15" value="" name="range"/>
                <hr>
                <label>Whant to show that max number is not the biggest one?</label>
                <input type="text" id="range_16" value="" name="range"/>
                <hr>
                <label>Taking care about how from and to values connect? Use decorate_both option:</label>
                ...
                <hr>
                <label>Use your own separator symbol with values_separator option. Like →</label>
                <input type="text" id="range_19" value="" name="range"/>
                <hr>
                <label>Or " to ":</label>
                <input type="text" id="range_20" value="" name="range"/>
                <hr>
                <label>You can disable all the sliders visual details, if you wish. Like this:</label>
                <input type="text" id="range_21" value="" name="range"/>
                <hr>
                <label>Or hide any part you wish</label>
                <input type="text" id="range_22" value="" name="range"/>
                <hr>
                <label>And some more</label>
