        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header text-uppercase">Switch Buttons</div>
             <div class="card-body">
               <p class="text-white"> add the following line <code> class="js-switch" data-color="#14abef"</code> to your input element. </p>
                    <div class="switchery-demo mt-3">
                     <input type="checkbox" checked class="js-switch" data-color="#14abef"/>
                     <input type="checkbox" checked class="js-switch" data-color="#02ba5a"/>
                     <input type="checkbox" checked class="js-switch" data-color="#03d0ea"/>
                     <input type="checkbox" checked class="js-switch" data-color="#607d8b"/>
                     <input type="checkbox" checked class="js-switch" data-color="#eb5076"/>
                     <input type="checkbox" checked class="js-switch" data-color="#000000"/>
                     <input type="checkbox" checked class="js-switch" data-color="#ff9700"/>
                    </div>
                    
                    
                   <h4 class="mt-3">Large Sizes</h4>
                  <p class="text-white"> You can add <code> data-size="large"</code> to your input element for different sizes. </p>
                  <div class="mt-3">
                      <input type="checkbox" checked class="js-switch" data-color="#14abef" data-size="large"/>
                      <input type="checkbox" checked class="js-switch" data-color="#02ba5a" data-size="large"/>
                      <input type="checkbox" checked class="js-switch" data-color="#03d0ea" data-size="large"/>
                      <input type="checkbox" checked class="js-switch" data-color="#607d8b" data-size="large"/>
                      <input type="checkbox" checked class="js-switch" data-color="#eb5076" data-size="large"/>
                      <input type="checkbox" checked class="js-switch" data-color="#000000" data-size="large"/>
                      <input type="checkbox" checked class="js-switch" data-color="#ff9700" data-size="large"/>
                    </div>
                    
                    
                    <h4 class="mt-3">Small Sizes</h4>
                    <p class="text-white"> You can add <code> data-size="small"</code> to your input element for different sizes. </p>
                    <div class="mt-3">
                      <input type="checkbox" checked class="js-switch" data-color="#14abef" data-size="small"/>
                      <input type="checkbox" checked class="js-switch" data-color="#02ba5a" data-size="small"/>
                      <input type="checkbox" checked class="js-switch" data-color="#03d0ea" data-size="small"/>
                      <input type="checkbox" checked class="js-switch" data-color="#607d8b" data-size="small"/>
                      <input type="checkbox" checked class="js-switch" data-color="#eb5076" data-size="small"/>
                      <input type="checkbox" checked class="js-switch" data-color="#000000" data-size="small"/>
                      <input type="checkbox" checked class="js-switch" data-color="#ff9700" data-size="small"/>
                    </div>

                  <h4 class="mt-3">Secondary color</h4>
                  <p class="text-white"> You can apply <code> data-color="@color" data-secondary-color="@color"</code> to your input element to both color. </p>
                  <div class="mt-3">
                      <input type="checkbox" class="js-switch" data-color="#eb5076" data-secondary-color="#03d0ea"/>
                      <input type="checkbox" class="js-switch" data-color="#000000" data-secondary-color="#607d8b"/>
                    </div>  
             </div>
          </div>
        </div>
          ...
          <div class="card">
            <div class="card-header text-uppercase">Bootstrap Switch Buttons</div>
             <div class="card-body bt-switch">
                <h4>Sizes</h4>
                  <p class="text-white">Just add <code>data-size="Size"</code> attribute to the <code>&lt;input type="checkbox"...&gt;</code>. Size values: <code>mini, small, normal, large</code>.</p>
                  <div class="mt-3">
                  ...
                  <h4>Colors</h4>
                  <p class="text-white">Just add <code>data-on-color="Color"</code> & <code>data-off-color="Color"</code> to the <code>&lt;input type="checkbox"...&gt;</code>. Color values: <code>primary, info, success, warning, danger, default</code>.</p>
                  <div class="mt-3">
                  ...
                  <p class="text-white">Just add <code>disabled</code> or <code>readonly</code> attribute to the <code>&lt;input type="checkbox"...&gt;</code>.</p>
                  <div class="mt-3">
                  ...
                  <p class="text-white">Just add <code>data-on-text="Text"</code> & <code>data-off-text="Text"</code> to the <code>&lt;input type="checkbox"...&gt;</code>.</p>
                  <div class="mt-3">
                  ...
                  <p class="text-white">Just add <code>data-on-text="Long Text"</code> & <code>data-off-text="Long Text"</code> to the <code>&lt;input type="checkbox"...&gt;</code>.</p>
                  <div class="mt-3">
                  ...
                  <p class="text-white">Just add <code>data-on-text="Text"</code> or <code>data-off-text="Text"</code> to the <code>&lt;input type="checkbox"...&gt;</code>.</p>
                  <div class="mt-3">
                  ...
                  <p class="text-white">Just add <code>data-on-text="HTML Text"</code> & <code>data-off-text="HTML Text"</code> to the <code>&lt;input type="checkbox"...&gt;</code>.</p>
                  <div class="mt-3">
                  ...
                  <p class="text-white">Just add class <code>radio-switch</code> to the <code>&lt;input type="radio"...&gt;</code>. If you want to change the class name, you have to change jquery according to that.</p>
                  <div class="mt-3">
