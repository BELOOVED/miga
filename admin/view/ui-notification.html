...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
	...
	<div class="card">
	 <div class="card-header text-uppercase">Default Notifications</div>
	 <div class="card-body">
	  <div class="row">
		...
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-info btn-block m-1" onclick="info_noti()">INFO</button>
		</div>
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-warning btn-block m-1" onclick="warning_noti()">WARNING</button>
		</div>
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-danger btn-block m-1" onclick="error_noti()">DANGER</button>
		</div>
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-success btn-block m-1" onclick="success_noti()">SUCCESS</button>
		</div>
	   </div><!--End Row-->
	  </div>
	 </div>
	...
	<div class="card">
	<div class="card-header text-uppercase">Rounded corners Notifications</div>
	 <div class="card-body">
	  <div class="row">
        <div class="col-12 col-lg-4 col-xl-2">
		...
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-info btn-block m-1" onclick="round_info_noti()">INFO</button>
		</div>
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-warning btn-block m-1" onclick="round_warning_noti()">WARNING</button>
		</div>
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-danger btn-block m-1" onclick="round_error_noti()">DANGER</button>
		</div>
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-success btn-block m-1" onclick="round_success_noti()">SUCCESS</button>
		</div>
	   </div><!--End Row-->
	  </div>
	 </div>
	...
	<div class="card">
	<div class="card-header text-uppercase">Notifications With image</div>
	 <div class="card-body">
	  <div class="row">
        <div class="col-12 col-lg-4 col-xl-2">
		...
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-info btn-block m-1" onclick="img_info_noti()">INFO</button>
		</div>
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-warning btn-block m-1" onclick="img_warning_noti()">WARNING</button>
		</div>
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-danger btn-block m-1" onclick="img_error_noti()">DANGER</button>
		</div>
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-success btn-block m-1" onclick="img_success_noti()">SUCCESS</button>
		</div>
	   </div><!--End Row-->
	  </div>
	 </div>
	...
	<div class="card">
	<div class="card-header text-uppercase">Alternative position</div>
	 <div class="card-body">
	  <div class="row">
        <div class="col-12 col-lg-4 col-xl-2">
		...
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-info btn-block m-1" onclick="pos2_info_noti()">INFO</button>
		</div>
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-warning btn-block m-1" onclick="pos3_warning_noti()">WARNING</button>
		</div>
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-danger btn-block m-1" onclick="pos4_error_noti()">DANGER</button>
		</div>
		<div class="col-12 col-lg-4 col-xl-2">
		  <button type="button" class="btn btn-success btn-block m-1" onclick="pos5_success_noti()">SUCCESS</button>
		</div>
	   </div><!--End Row-->
	  </div>
	 </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header text-uppercase">Notification With Animation</div>
            <div class="card-body">
              ...
              <table class="table">
               ...
               <tbody>
                   <tr>
                       <td>fadeInDown</td>
                       <td>fadeOutDown</td>
                       <td><button class="btn btn-dark" onclick="anim1_noti()">SHOW ME</button></td>
                   </tr>
                   <tr>
                       <td>bounceIn</td>
                       <td>bounceOut</td>
                       <td><button class="btn btn-info" onclick="anim2_noti()">SHOW ME</button></td>
                   </tr>
                   <tr>
                       <td>zoomIn</td>
                       <td>zoomOut</td>
                       <td><button class="btn btn-warning" onclick="anim3_noti()">SHOW ME</button></td>
                   </tr>
                   <tr>
                       <td>lightSpeedIn</td>
                       <td>lightSpeedOut</td>
                       <td><button class="btn btn-danger" onclick="anim4_noti()">SHOW ME</button></td>
                   </tr>
                   <tr>
                       <td>rollIn</td>
                       <td>rollOut</td>
