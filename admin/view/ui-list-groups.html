  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
	 ...
	 <div class="row">
        <div class="col-lg-6">
		  <div class="card">
		    <div class="card-header text-uppercase">Simple List Group</div>
			 <div class="card-body">
			    <ul class="list-group">
		...
		<div class="col-lg-6">
		  <div class="card">
		    <div class="card-header text-uppercase">List Group with Links</div>
			 <div class="card-body">
			    <div class="list-group">
				  <a href="javaScript:void();" class="list-group-item list-group-item-action">Cras justo odio</a>
				  <a href="javaScript:void();" class="list-group-item list-group-item-action">Dapibus ac facilisis in</a>
				  <a href="javaScript:void();" class="list-group-item list-group-item-action">Morbi leo risus</a>
				  <a href="javaScript:void();" class="list-group-item list-group-item-action">Porta ac consectetur ac</a>
				  <a href="javaScript:void();" class="list-group-item list-group-item-action disabled">Vestibulum at eros</a>
				</div>
			 </div>
		  </div>
		</div>
	 ...
	 <div class="row">
        <div class="col-lg-6">
		  <div class="card">
		    <div class="card-header text-uppercase">Simple List Active</div>
			 <div class="card-body">
			    <ul class="list-group">
		...
		<div class="col-lg-6">
		  <div class="card">
		    <div class="card-header text-uppercase">List Group with Active Link</div>
			 <div class="card-body">
			    <div class="list-group">
	 ...
	 <div class="row">
        <div class="col-lg-6">
		  <div class="card">
		    <div class="card-header text-uppercase">List Group with badges</div>
			 <div class="card-body">
			    <ul class="list-group">
		...
		<div class="col-lg-6">
		  <div class="card">
		    <div class="card-header text-uppercase">List Group with Contextual classes</div>
			 <div class="card-body">
			    <ul class="list-group">
                    <li class="list-group-item">Dapibus ac facilisis in</li>
			 ...
			 <div class="card-body">
			    <div class="list-group">
                    ...
                    <a href="javaScript:void();" class="list-group-item list-group-item-action flex-column align-items-start">
                      ...
                      <p class="mb-1">Donec id elit non mi porta gravida at eget metus. Maecenas sed diam eget risus varius blandit.</p>
                      <small class="text-white">Donec id elit non mi porta.</small>
                    </a>
                    <a href="javaScript:void();" class="list-group-item list-group-item-action flex-column align-items-start">
                      <div class="d-flex w-100 justify-content-between">
                        <h5 class="mb-1">List group item heading</h5>
