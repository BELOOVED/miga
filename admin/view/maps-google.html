    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
             <div class="card-header text-uppercase">Over Layer Map</div>
              <div class="card-body">
               <div id="overlay-map" class="gmaps"></div>
              </div>
          </div>
          <div class="card">
             <div class="card-header text-uppercase">Polygonal Map</div>
              <div class="card-body">
          ...
          <div class="card">
             <div class="card-header text-uppercase">Styled Map</div>
              <div class="card-body">
