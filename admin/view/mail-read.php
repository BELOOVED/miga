            ...
            <div class="col-lg-3 col-md-4">
                ...
                <div class="card mt-3 shadow-none">
                    <div class="list-groups shadow-none">
                      <a href="javascript:void();" class="list-group-item bg-light-dark"><i class="fa fa-inbox mr-2"></i>Inbox <b>(12)</b></a>
                      ...
                      <a href="javascript:void();" class="list-group-item"><span class="fa fa-circle text-white float-right"></span>Family</a>
                      <a href="javascript:void();" class="list-group-item"><span class="fa fa-circle text-warning float-right"></span>Friends</a>
                 ...
                 <div class="media mb-3">
                  ...
                  <div class="row">
                      <div class="col-sm-4 col-md-3">
                          <a href="javascript:void();"> <img src="https://via.placeholder.com/800x500" alt="attachment" class="img-thumbnail"> </a>
                      </div>
                      <div class="col-sm-4 col-md-3">
                          <a href="javascript:void();"> <img src="https://via.placeholder.com/800x500" alt="attachment" class="img-thumbnail"> </a>
                      </div>
