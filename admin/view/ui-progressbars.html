...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
	...
	<div class="row">
        <div class="col-lg-12">
		 <div class="card">
		 <div class="card-header text-uppercase">Basic examples</div>
            <div class="card-body">
		...
		<div class="col-lg-12">
		 <div class="card">
		 <div class="card-header text-uppercase">background color</div>
            <div class="card-body">
			  <div class="progress-wrapper">
			   <div class="progress mb-4" style="height:5px;">
		...
		<div class="col-lg-12">
		 <div class="card">
		 <div class="card-header text-uppercase">Striped Progress Bars</div>
            <div class="card-body">
			  <div class="progress-wrapper">
			   <div class="progress mb-4" style="height:5px;">
				  <div class="progress-bar bg-primary progress-bar-striped progress-bar-animated" style="width:20%"></div>
			   </div>
			  </div><!--end progress wrapper-->
			  
			  <div class="progress-wrapper">
			   <div class="progress mb-4" style="height:5px;">
				<div class="progress-bar bg-success progress-bar-striped progress-bar-animated" style="width:30%"></div>
			   </div>
			  </div><!--end progress wrapper-->
			  ...
			  <div class="progress-wrapper">
			   <div class="progress mb-4" style="height:5px;">
				<div class="progress-bar bg-info progress-bar-striped progress-bar-animated" style="width:95%"></div>
			   </div>
			  </div><!--end progress wrapper-->
		...
		<div class="col-lg-12">
		 <div class="card">
		 <div class="card-header text-uppercase">Gradient colors</div>
            <div class="card-body">
			  <div class="progress-wrapper">
			   <div class="progress mb-4" style="height:5px;">
				  <div class="progress-bar gradient-ibiza" style="width:20%"></div>
			   </div>
			  </div><!--end progress wrapper-->
			  
			  <div class="progress-wrapper">
			   <div class="progress mb-4" style="height:5px;">
				<div class="progress-bar gradient-branding" style="width:30%"></div>
			   </div>
			  </div><!--end progress wrapper-->
			  
			  <div class="progress-wrapper">
			   <div class="progress mb-4" style="height:5px;">
				<div class="progress-bar gradient-ohhappiness" style="width:50%"></div>
			   </div>
			  </div><!--end progress wrapper-->
			  
			  <div class="progress-wrapper">
			   <div class="progress mb-4" style="height:5px;">
				<div class="progress-bar gradient-hossein" style="width:80%"></div>
			   </div>
			  </div><!--end progress wrapper-->
			  
			  <div class="progress-wrapper">
			   <div class="progress mb-4" style="height:5px;">
				<div class="progress-bar gradient-purpink" style="width:95%"></div>
			   </div>
			  </div><!--end progress wrapper-->
		...
		<div class="col-lg-12">
		 <div class="card">
		  <div class="card-header text-uppercase">Multiple Progress Bars</div>
            <div class="card-body">
			  <div class="progress-wrapper">
			   <div class="progress mb-4" style="height:5px;">
