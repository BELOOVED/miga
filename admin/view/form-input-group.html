  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Input Group</h4>
		    <ol class="breadcrumb">
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="card">
          <div class="card-header text-uppercase">Left Input Addon</div>
          <div class="card-body">
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-header text-uppercase">Right Input Addon</div>
          <div class="card-body">
             <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="some text">
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="card">
          <div class="card-header text-uppercase">Left Input Addon with icon</div>
          <div class="card-body">
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-header text-uppercase">Right Input Addon with icon</div>
          <div class="card-body">
             <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="some text">
                <div class="input-group-append">
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="card">
          <div class="card-header text-uppercase">Both Side Input Addon</div>
          <div class="card-body">
            <div class="input-group">
              <div class="input-group-prepend">
                <span class="input-group-text">$</span>
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-header text-uppercase">Both side input Addon with icons</div>
          <div class="card-body">
             <div class="input-group">
                <div class="input-group-prepend">
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="card">
          <div class="card-header text-uppercase">Left Input Addon with spinner</div>
          <div class="card-body">
            <div class="input-group">
              <div class="input-group-prepend">
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-header text-uppercase">Right Input Addon with spinner</div>
          <div class="card-body">
             <div class="input-group">
                <input type="text" class="form-control" placeholder="some text"/>
                <div class="input-group-append">
			     ...
			     <div class="card-body">
				    <form>
						...
						<div class="form-group row">
						  <label for="both-side-spinner" class="col-sm-3 col-form-label">Both Side Spinner Icons</label>
						  <div class="col-sm-9">
							<div class="input-group mb-3">
								<div class="input-group-prepend">
								  <span class="input-group-text"><i class="fa fa-cog fa-spin"></i></span>
								</div>
								<input type="text" class="form-control" id="both-side-spinner"/>
								<div class="input-group-append">
						...
						<div class="form-group row">
						  <label for="input-addon-checkbox" class="col-sm-3 col-form-label">Input Addon with checkbox</label>
						  <div class="col-sm-9">
							<div class="input-group mb-3">
								<div class="input-group-prepend">
								...
								<input type="text" class="form-control" id="input-addon-checkbox"/>
							  </div>
						  </div>
						</div>
						
						<div class="form-group row">
						  <label for="input-addon-radio" class="col-sm-3 col-form-label">Input Addon with radio</label>
						  <div class="col-sm-9">
							<div class="input-group mb-3">
								<div class="input-group-prepend">
								  <div class="input-group-text">
								  <input type="radio" id="input-addon-radio">
								  </div>
								</div>
								<input type="text" class="form-control">
							  </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
             <div class="card-header text-uppercase">Input Addon with different sizes</div>
             <div class="card-body">
                <p>Small Input Addon</p>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
             <div class="card-header text-uppercase">Multiple inputs gruops & add-ons</div>
             <div class="card-body">
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
     ...
     <div class="row">
      <div class="col-lg-6">
        <div class="card">
          <div class="card-header text-uppercase">Input Group with Left Button</div>
          <div class="card-body">
            <div class="input-group">
              <div class="input-group-prepend">
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-header text-uppercase">Input Group with Right Button</div>
          <div class="card-body">
             <div class="input-group">
                <input type="text" class="form-control" placeholder="some text">
                <div class="input-group-append">
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="card">
          <div class="card-header text-uppercase">Both Side Button</div>
          <div class="card-body">
            <div class="input-group">
              <div class="input-group-prepend">
              ...
              <input type="text" class="form-control" placeholder="some text">
                <div class="input-group-append">
                 <button class="btn btn-light" type="button">Reset</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-header text-uppercase">With Both Side icon Button</div>
          <div class="card-body">
             <div class="input-group">
                <div class="input-group-prepend">
        ...
        <div class="col-lg-12">
		     <div class="card">
			   <div class="card-header text-uppercase">Input Group with Dropdown Buttons</div>
			     <div class="card-body">
				    <form>

						<div class="form-group row">
						  <label for="left-dropdown" class="col-sm-3 col-form-label">Left Dropdown</label>
						  <div class="col-sm-9">
							<div class="input-group mb-3">
							  <div class="input-group-prepend">
							  ...
							  <input type="text" class="form-control" id="left-dropdown">
							</div>
						  </div>
						</div>
						
						<div class="form-group row">
						  <label for="right-dropdown" class="col-sm-3 col-form-label">Right Dropdown</label>
						  <div class="col-sm-9">
							<div class="input-group mb-3">
							  <input type="text" class="form-control" id="right-dropdown">
							  <div class="input-group-append">
								<button class="btn btn-light dropdown-toggle" type="button" data-toggle="dropdown">Dropdown</button>
								<div class="dropdown-menu">
								  <a class="dropdown-item" href="#">Action</a>
						...
						<div class="form-group row">
						  <label for="both-side-input-dropdown" class="col-sm-3 col-form-label">Both Side Dropdown</label>
						  <div class="col-sm-9">
							<div class="input-group mb-3">
							  <div class="input-group-prepend">
								<button class="btn btn-light dropdown-toggle" data-toggle="dropdown" type="button">Dropdown</button>
								<div class="dropdown-menu">
								  <a class="dropdown-item" href="#">Action</a>
								  <a class="dropdown-item" href="#">Another action</a>
								  <a class="dropdown-item" href="#">Something else here</a>
							  ...
							  <input type="text" class="form-control" id="both-side-input-dropdown">
							  <div class="input-group-append">
								<button class="btn btn-light dropdown-toggle" data-toggle="dropdown" type="button">Dropdown</button>
								<div class="dropdown-menu">
								  <a class="dropdown-item" href="#">Action</a>
						...
						<div class="form-group row">
						  <label for="segmented-button" class="col-sm-3 col-form-label">Left Side Segmented button</label>
						  <div class="col-sm-9">
							<div class="input-group mb-3">
							  <div class="input-group-prepend">
							  ...
							  <input type="text" class="form-control" id="segmented-button">
							</div>
						  </div>
						</div>
						
						<div class="form-group row">
						  <label for="right-segmented-button" class="col-sm-3 col-form-label">Right Side Segmented button</label>
						  <div class="col-sm-9">
							<div class="input-group mb-3">
							  <input type="text" class="form-control" id="right-segmented-button">
							  <div class="input-group-append">
								<button type="button" class="btn btn-light">Action</button>
								<button type="button" class="btn btn-light dropdown-toggle dropdown-toggle-split" data-toggle="dropdown">
								  <span class="sr-only">Toggle Dropdown</span>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
             <div class="card-header text-uppercase">Input group with Custom select</div>
             <div class="card-body">
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
             <div class="card-header text-uppercase">Input group with Custom file input</div>
             <div class="card-body">
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
