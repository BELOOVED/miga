...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
	  ...
	  <div class="row">
	   <div class="col col-lg-12 col-xl-12">
	    <div class="card">
	     <div class="card-header text-uppercase">Bootstrap Headings</div>
		   <div class="card-body">
			 <div class="demo-heading">Heading 1</div> 
           <h1 class="mb-0">Bootstrap Heading 1</h1>

           <div class="demo-heading">Heading 2</div> 
           <h2 class="mb-0">Bootstrap Heading 2</h2>

           <div class="demo-heading">Heading 3</div> 
           <h3 class="mb-0">Bootstrap Heading 3</h3>

           <div class="demo-heading">Heading 4</div> 
           <h4 class="mb-0">Bootstrap Heading 4</h4>

           <div class="demo-heading">Heading 5</div> 
           <h5 class="mb-0">Bootstrap Heading 5</h5>

           <div class="demo-heading">Heading 6</div> 
    ...
    <div class="row">
            <div class="col-lg-4">
              <div class="card">
                <div class="card-header text-uppercase">Unordered list</div>
                <div class="card-body">
                  <ul>
            ...
            <div class="col-lg-4">
              <div class="card">
                <div class="card-header text-uppercase">Ordered list</div>
                <div class="card-body">
                  <ol>
                    <li>Lorem ipsum dolor sit amet</li>
                    <li>Consectetur adipiscing elit</li>
  ...
  <div class="row">
    ...
    <div class="col-lg-12">
       <div class="card">
          <div class="card-header text-uppercase">Blockquotes with right alighned</div>
          <div class="card-body">
  ...
  <div class="row">
       ...
       <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="media mt-3">
              <img class="mr-3 rounded-circle" src="https://via.placeholder.com/110x110" alt="user avatar">
              <div class="media-body">
                <h5 class="mt-0">Media heading</h5>
                Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. 
              </div>
    ...
    <div class="col-lg-6">
       <div class="card">
          <div class="card-header text-uppercase">Media object right alighned</div>
          <div class="card-body">
           <div class="media">
              <div class="media-body">
                <h5 class="mt-0">Media heading</h5>
              ...
              <img class="ml-3 rounded" src="https://via.placeholder.com/110x110" alt="user avatar">
            </div>
            <div class="media mt-3">
              <div class="media-body">
                <h5 class="mt-0">Media heading</h5>
              ...
              <img class="ml-3 rounded-circle" src="https://via.placeholder.com/110x110" alt="user avatar">
            </div>
          </div>
        </div>
    </div>
  ...
  <div class="row">
    <div class="col-lg-12">
       <div class="card">
          <div class="card-header text-uppercase">Media list objects</div>
          <div class="card-body">
            <ul class="list-unstyled">
              <li class="media">
                <img class="mr-3 rounded" src="https://via.placeholder.com/110x110" alt="user avatar"/>
