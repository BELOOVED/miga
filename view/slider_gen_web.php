        ...
        <div class="swiper-wrapper slick-slider" id="swiper-wrapper-9d019d3871f7b504" aria-live="off" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
            <?php
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    if ($slide_index == 0 ){
                        echo '<div data-swiper-slide-index="' . strval($slide_index) . '" class="swiper-slide swiper-slide-duplicate swiper-slide-prev" style="width: 1140px; role="group" aria-label="1 / 19">';
                        ...
                        echo '<div data-swiper-slide-index="' . strval($slide_index) . '" class="swiper-slide swiper-slide-duplicate swiper-slide-prevg" style="width: 1140px; role="group" aria-label="1 / 19">';
                        echo '<a href="' . $row['url'] . '"><img alt="" class="swiper-lazy swiper-lazy-loaded" src="https://external-content.duckduckgo.com/iu/?u=' . $row['image'] . '"></a>';
                        echo '<div class="swiper-placeholder"><div class="swiper-lazy-preloader"></div><img src="assets/images/banner_placeholder.webp" alt=""><!----></div>';
                        echo '</div>';
                    }
