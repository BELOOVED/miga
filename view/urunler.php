                                ...
                                foreach ($kategoriler as $kategori) {
                                    ...
                                    foreach ($alt_kategoriler as $alt_kategori) {
                                        ...
                                        <div class="item extra-margin ng-star-inserted">
                                            <a class="text-color-black mat-body-2 ng-star-inserted" ngx-ql="" href="/urunler/<?=seo($alt_kategori)?>/<?=$kategori['id']?>"> <?=$alt_kategori?> <span class="text-color-grey"></span></a>
                                        </div>
                                        <?php }?>
                                    ...
                                    <!---->
                                      ...
                                      <?php }?>  
                                        ...
                                        <sm-product-actions id="actions" class="actions" _nghost-nyw-c292="">
                                            <!---->
                                            <fa-icon onclick="addToCart(<?=$urun['id'];?>)" _ngcontent-nyw-c292="" class="ng-fa-icon add-to-cart-button ng-star-inserted" id="product-actions-add-to-cart-button--xiaomi-redmi-buds-3-bluetooth-kulaklik-beyaz-p-255e133">
...
<div class="cdk-overlay-container elektronik hidden" id="sirala2" style="postion: static;">
   <div class="cdk-overlay-backdrop cdk-overlay-transparent-backdrop cdk-overlay-backdrop-showing" onclick="closemodal()"></div>
