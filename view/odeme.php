<main _ngcontent-hdw-c372="" class="elektronik">
   <router-outlet _ngcontent-hdw-c372=""></router-outlet>
   <sm-checkout _nghost-hdw-c465="">
      <!----><!---->
      <fe-line-checkout-steps _ngcontent-hdw-c465="" _nghost-hdw-c248="" class="ng-star-inserted">
         <a _ngcontent-hdw-c248="" routerlinkactive="active" class="checkout-step disabled ng-star-inserted" id="checkout-steps_1" href="/elektronik/siparis/adres/358350875">
            <div _ngcontent-hdw-c248="" class="checkout-step__number"><span _ngcontent-hdw-c248="">1</span></div>
            <div _ngcontent-hdw-c248="" class="checkout-step__title"><span _ngcontent-hdw-c248="">ADRES</span></div>
            <div _ngcontent-hdw-c248="" class="checkout-step__arrow ng-star-inserted">
               <fa-icon _ngcontent-hdw-c248="" class="ng-fa-icon">
         ...
         <a _ngcontent-hdw-c248="" routerlinkactive="active" class="checkout-step disabled ng-star-inserted" id="checkout-steps_2" href="/elektronik/siparis/teslimat-zamani/358350875">
            <div _ngcontent-hdw-c248="" class="checkout-step__number"><span _ngcontent-hdw-c248="">2</span></div>
            <div _ngcontent-hdw-c248="" class="checkout-step__title"><span _ngcontent-hdw-c248="">TESLİMAT</span></div>
            <div _ngcontent-hdw-c248="" class="checkout-step__arrow ng-star-inserted">
               <fa-icon _ngcontent-hdw-c248="" class="ng-fa-icon">
                  <svg role="img" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-right" class="svg-inline--fa fa-chevron-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                     <path fill="currentColor" d="M342.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L274.7 256 105.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"></path>
         ...
         <a _ngcontent-hdw-c248="" routerlinkactive="active" class="checkout-step disabled ng-star-inserted active" id="checkout-steps_3" href="/elektronik/siparis/odeme/358350875">
            <div _ngcontent-hdw-c248="" class="checkout-step__number"><span _ngcontent-hdw-c248="">3</span></div>
            <div _ngcontent-hdw-c248="" class="checkout-step__title"><span _ngcontent-hdw-c248="">ÖDEME</span></div>
            <!---->
         </a>
         <!----><!---->
      </fe-line-checkout-steps>
      <!----><!----><!---->
      <article _ngcontent-hdw-c465="">
         <router-outlet _ngcontent-hdw-c465=""></router-outlet>
         <sm-delivery-payment>
            <div class="page-container ng-star-inserted">
               <div class="mdc-layout-grid__inner">
                  <div class="checkout-container mdc-layout-grid__cell--span-8 mdc-layout-grid__cell--span-5-tablet mdc-layout-grid__cell--span-4-phone">
                     <sm-single-checkout-steps>
                        ...
                        <div class="step completed ng-star-inserted">
                           ...
                           <div class="step-content">
                              ...
                              <div class="content">
                                 <!---->
                                 <sm-delivery-time-info _nghost-hdw-c475="" class="ng-star-inserted">
                                    <div _ngcontent-hdw-c475="" class="delivery-time-wrapper subtitle-2">
                                       <!----><img _ngcontent-hdw-c475="" alt="" srcset="/assets/images/msm-arac.webp, /assets/images/msm-arac@2x.webp 2x, /assets/images/msm-arac@3x.webp 3x" class="ng-star-inserted"><!---->
                                       <div _ngcontent-hdw-c475="" class="info-wrapper">
                                          <div _ngcontent-hdw-c475="">Randevulu Teslimat</div>
                                          <div _ngcontent-hdw-c475="" class="delivery-time text-color-success">
                                             24 Aralık Pazar (Yarın)<span _ngcontent-hdw-c475="" class="ng-star-inserted">, 14:00 - 22:00</span><!---->
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <mat-radio-group role="radiogroup" color="primary" class="mat-mdc-radio-group">
                                       ...
                                       <div class="option-wrapper ng-star-inserted active">
                                          ...
                                          <sm-online-credit-card class="ng-star-inserted">
                                             <sm-masterpass-wrapper _nghost-hdw-c481="">
                                                <div _ngcontent-hdw-c481="" class="masterpass-wrapper ng-star-inserted">
                                                   <sm-masterpass-card-list _ngcontent-hdw-c481="">
                                                      <div class="ng-star-inserted">
                                                                     ...
                                                                     <div class="mat-mdc-text-field-wrapper mdc-text-field ng-tns-c188-4 mdc-text-field--outlined">
                                                                        ...
                                                                        <div class="mat-mdc-form-field-flex ng-tns-c188-4">
                                                                           ...
                                                                           <div class="mat-mdc-form-field-icon-suffix ng-tns-c188-4 ng-star-inserted">
                                                                              <fa-icon matsuffix="" mattooltip="Kartınızın arka yüzünde bulunan rakamların genellikle son üç hanesidir." class="ng-fa-icon mat-tooltip-trigger ng-tns-c188-4" style="user-select: none; -webkit-user-drag: none; touch-action: none; -webkit-tap-highlight-color: transparent;" aria-describedby="cdk-describedby-message-hdw-1-2" cdk-describedby-host="hdw-1">
                                                         ...
                                                         <!----><!---->
                                                         <form novalidate="" class="ng-untouched ng-pristine ng-valid"><input type="hidden" name="token"><input type="hidden" name="accountAliasName"><input type="hidden" name="msisdn"><input type="hidden" name="referenceNo" value="101252836185"><input type="hidden" name="sendSmsLanguage" value="tur"><input type="hidden" name="sendSms" value="N"><input type="hidden" name="setLanguage" value="tur"></form>
                                                         <form novalidate="" class="ng-untouched ng-pristine ng-valid"><input type="hidden" name="token"><input type="hidden" name="oldValue" value=""><input type="hidden" name="theNewValue"><input type="hidden" name="valueType" value="USER_ID"><input type="hidden" name="msisdn"><input type="hidden" name="fP"><input type="hidden" name="referenceNo" value="101252836185"><input type="hidden" name="sendSmsLanguage" value="tur"><input type="hidden" name="sendSms" value="N"><input type="hidden" name="setLanguage" value="tur"></form>
                                                         <!---->
                                                      </div>
                                                      <!----><!---->
                                                   </sm-masterpass-card-list>
                                                   <fe-masterpass-purchase _ngcontent-hdw-c481="" _nghost-hdw-c324="">
                                                      <form _ngcontent-hdw-c324="" novalidate="" class="ng-untouched ng-pristine ng-valid"><input _ngcontent-hdw-c324="" type="hidden" name="amount"><input _ngcontent-hdw-c324="" type="hidden" name="installmentCount"><input _ngcontent-hdw-c324="" type="hidden" name="listAccountName"><input _ngcontent-hdw-c324="" type="hidden" name="token"><input _ngcontent-hdw-c324="" type="hidden" name="orderNo"><input _ngcontent-hdw-c324="" type="hidden" name="msisdn"><input _ngcontent-hdw-c324="" type="hidden" name="referenceNo" value="101252836185"><input _ngcontent-hdw-c324="" type="hidden" name="sendSmsLanguage" value="tur"><input _ngcontent-hdw-c324="" type="hidden" name="sendSms" value="N"><input _ngcontent-hdw-c324="" type="hidden" name="aav" value="aav"><input _ngcontent-hdw-c324="" type="hidden" name="clientIp" value=""><input _ngcontent-hdw-c324="" type="hidden" name="encCPin" value="0"><input _ngcontent-hdw-c324="" type="hidden" name="encPassword" value=""><input _ngcontent-hdw-c324="" type="hidden" name="sendSmsMerchant" value="Y"><input _ngcontent-hdw-c324="" type="hidden" name="password" value=""></form>
                        ...
                        <sm-side-payment>
                           <section class="ng-star-inserted">
                              ...
                              <mat-accordion class="mat-accordion accordion">
                                 <sm-side-payment-panel-money id="side-payment-panel-money-point" _nghost-hdw-c489="" class="ng-star-inserted">
                                    <!---->
                                 </sm-side-payment-panel-money>
                                 <!----><!---->
                                 <sm-side-payment-panel-customer-bond id="side-payment-panel-customer-bond" _nghost-hdw-c493="" class="ng-star-inserted">
                                    <!---->
                                 </sm-side-payment-panel-customer-bond>
                                 <!---->
                                 <sm-side-payment-panel-voucher id="side-payment-panel-voucher" class="ng-star-inserted">
                                    <sm-side-payment-panel _nghost-hdw-c488="">
                                       <mat-expansion-panel _ngcontent-hdw-c488="" hidetoggle="" class="mat-expansion-panel ng-tns-c97-5 ng-star-inserted">
                                          <mat-expansion-panel-header _ngcontent-hdw-c488="" role="button" class="mat-expansion-panel-header mat-focus-indicator ng-tns-c98-6 ng-tns-c97-5 mat-expansion-toggle-indicator-after ng-star-inserted" id="mat-expansion-panel-header-0" tabindex="0" aria-controls="cdk-accordion-child-0" aria-expanded="false" aria-disabled="false">
                                             <span class="mat-content ng-tns-c98-6 mat-content-hide-toggle">
                                                <mat-panel-title _ngcontent-hdw-c488="" class="mat-expansion-panel-header-title ng-tns-c98-6">
                                                ...
                                                <mat-panel-description _ngcontent-hdw-c488="" class="mat-expansion-panel-header-description ng-tns-c98-6">
                                                   <fa-icon _ngcontent-hdw-c488="" class="ng-fa-icon toggle text-color-orange">
                                          ...
                                          <div role="region" class="mat-expansion-panel-content ng-tns-c97-5 ng-trigger ng-trigger-bodyExpansion" id="cdk-accordion-child-0" aria-labelledby="mat-expansion-panel-header-0" style="height: 0px; visibility: hidden;">
                                             <div class="mat-expansion-panel-body ng-tns-c97-5">
                                                <sm-side-payment-form type="string" defaultplaceholder="Dijital alışveriş kodu girin" _nghost-hdw-c487="" class="ng-tns-c97-5">
                                                   <div _ngcontent-hdw-c487="" class="container">
                                                      <div _ngcontent-hdw-c487="" class="mat-caption-normal text-color-grey"></div>
                                                      <form _ngcontent-hdw-c487="" novalidate="" feappsubmitthrottle="" class="form ng-untouched ng-pristine ng-invalid">
                                                         <mat-form-field _ngcontent-hdw-c487="" color="accent" appearance="outline" class="mat-mdc-form-field ng-tns-c188-7 mat-mdc-form-field-type-mat-input mat-mdc-form-field-has-icon-suffix mat-form-field-appearance-outline mat-accent ng-untouched ng-pristine ng-invalid ng-star-inserted" style="">
                                                            <!---->
                                                            <div class="mat-mdc-text-field-wrapper mdc-text-field ng-tns-c188-7 mdc-text-field--outlined mdc-text-field--no-label">
                                                               ...
                                                               <div class="mat-mdc-form-field-flex ng-tns-c188-7">
                                                                  ...
                                                                  <div class="mat-mdc-form-field-infix ng-tns-c188-7">
                                                                     <!----><input _ngcontent-hdw-c487="" matinput="" class="mat-mdc-input-element mat-mdc-form-field-input-control mdc-text-field__input ng-untouched ng-pristine ng-invalid cdk-text-field-autofill-monitored ng-star-inserted" maxlength="16" placeholder="Dijital alışveriş kodu girin" required="" id="mat-input-5" data-placeholder="Dijital alışveriş kodu girin" aria-required="true"><!----><!----><!---->
                                                                  </div>
                                                                  <!---->
                                                                  <div class="mat-mdc-form-field-icon-suffix ng-tns-c188-7 ng-star-inserted"><span _ngcontent-hdw-c487="" matsuffix="" class="input-label subtitle-2 ng-tns-c188-7"></span></div>
                                                                  <!---->
                                                               </div>
                                                               <!---->
                                                            </div>
                                                         ...
                                                         <fe-button _ngcontent-hdw-c487="" type="submit" label="Kullan" class="submit-button ng-star-inserted" _nghost-hdw-c241="" style="">
                                                            <button _ngcontent-hdw-c241="" mat-flat-button="" color="primary" class="mdc-button mdc-button--unelevated mat-mdc-unelevated-button mat-primary mat-mdc-button-base ng-star-inserted" type="submit">
                                 ...
                                 <sm-side-payment-panel-coupon id="side-payment-panel-coupon" class="ng-star-inserted">
                                    <sm-side-payment-panel _nghost-hdw-c488="">
                                       <mat-expansion-panel _ngcontent-hdw-c488="" hidetoggle="" class="mat-expansion-panel ng-tns-c97-8 ng-star-inserted">
                                          <mat-expansion-panel-header _ngcontent-hdw-c488="" role="button" class="mat-expansion-panel-header mat-focus-indicator ng-tns-c98-9 ng-tns-c97-8 mat-expansion-toggle-indicator-after ng-star-inserted" id="mat-expansion-panel-header-1" tabindex="0" aria-controls="cdk-accordion-child-1" aria-expanded="false" aria-disabled="false">
                                             <span class="mat-content ng-tns-c98-9 mat-content-hide-toggle">
                                                <mat-panel-title _ngcontent-hdw-c488="" class="mat-expansion-panel-header-title ng-tns-c98-9">
                                                   <fa-icon class="ng-fa-icon icon">
                                                ...
                                                <mat-panel-description _ngcontent-hdw-c488="" class="mat-expansion-panel-header-description ng-tns-c98-9">
                                                   <fa-icon _ngcontent-hdw-c488="" class="ng-fa-icon toggle text-color-orange">
                                                      <svg role="img" aria-hidden="true" focusable="false" data-prefix="far" data-icon="plus" class="svg-inline--fa fa-plus" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                                         <path fill="currentColor" d="M432 256C432 269.3 421.3 280 408 280h-160v160c0 13.25-10.75 24.01-24 24.01S200 453.3 200 440v-160h-160c-13.25 0-24-10.74-24-23.99C16 242.8 26.75 232 40 232h160v-160c0-13.25 10.75-23.99 24-23.99S248 58.75 248 72v160h160C421.3 232 432 242.8 432 256z"></path>
                                                      </svg>
                                          ...
                                          <div role="region" class="mat-expansion-panel-content ng-tns-c97-8 ng-trigger ng-trigger-bodyExpansion" id="cdk-accordion-child-1" aria-labelledby="mat-expansion-panel-header-1" style="height: 0px; visibility: hidden;">
                                             <div class="mat-expansion-panel-body ng-tns-c97-8">
                                                <sm-side-payment-form type="string" defaultplaceholder="Kupon Kodu Ekle" _nghost-hdw-c487="" class="ng-tns-c97-8">
                                                   <div _ngcontent-hdw-c487="" class="container">
                                                      <div _ngcontent-hdw-c487="" class="mat-caption-normal text-color-grey">
                                                         Hesabınıza tanımlı hediye çekleri arasından seçim yapabilir, dilerseniz yeni hediye çeki ekleyebilirsiniz. <!---->
                                                      </div>
                                                      <form _ngcontent-hdw-c487="" novalidate="" feappsubmitthrottle="" class="form ng-untouched ng-pristine ng-invalid">
                                                         <mat-form-field _ngcontent-hdw-c487="" color="accent" appearance="outline" class="mat-mdc-form-field ng-tns-c188-10 mat-mdc-form-field-type-mat-input mat-mdc-form-field-has-icon-suffix mat-form-field-appearance-outline mat-accent ng-untouched ng-pristine ng-invalid ng-star-inserted" style="">
                                                            <!---->
                                                            <div class="mat-mdc-text-field-wrapper mdc-text-field ng-tns-c188-10 mdc-text-field--outlined mdc-text-field--no-label">
                                                               ...
                                                               <div class="mat-mdc-form-field-flex ng-tns-c188-10">
                                                                  ...
                                                                  <!---->
                                                                  <div class="mat-mdc-form-field-icon-suffix ng-tns-c188-10 ng-star-inserted"><span _ngcontent-hdw-c487="" matsuffix="" class="input-label subtitle-2 ng-tns-c188-10"></span></div>
                                                                  <!---->
                                                               </div>
                                                               <!---->
                                                            </div>
                     ...
                     <!----><!---->
                     <sm-add-delivery-note class="mobile-only ng-star-inserted" _nghost-hdw-c496="">
                        <div _ngcontent-hdw-c496="" class="delivery-note-wrapper">
                           <div _ngcontent-hdw-c496="" class="icon-text">
                              <fa-icon _ngcontent-hdw-c496="" class="ng-fa-icon">
                              ...
                              <span _ngcontent-hdw-c496="" class="mat-caption">Sipariş Notu Ekle</span>
                           </div>
                           <textarea _ngcontent-hdw-c496="" id="add-delivery-note-area" class="mat-caption-normal delivery-note-textarea" placeholder="Siparişinle ilgili notunu buradan bize iletebilirsin."></textarea>
                        </div>
                     </sm-add-delivery-note>
                     <!---->
                     <fe-card-provision-info class="mobile-only ng-star-inserted" _nghost-hdw-c323="">
                        <div _ngcontent-hdw-c323="" class="container ng-star-inserted">
                           <div _ngcontent-hdw-c323="" class="subtitle-2 text-color-info header">
                              <fa-icon _ngcontent-hdw-c323="" class="ng-fa-icon header--icon">
                              ...
                              <div _ngcontent-hdw-c323="">Banka Provizyonu Hakkında</div>
                           </div>
                           <div _ngcontent-hdw-c323="" class="mat-caption-normal text-color-info"> Sipariş tutarı kartınızda provizyonda bekler, siparişiniz size teslim edildiğinde sadece teslim aldığınız ürünlerin ücreti kartınızdan çekilir, tedarik edilmeyen ürünler için ücret ödemezsiniz. Kartınızdan alınan provizyon oranı bankanıza göre değişiklik göstermektedir. </div>
                        </div>
                        <!---->
                     </fe-card-provision-info>
                     <!---->
                     <fe-line-checkout-price-summary class="mobile-only" _nghost-hdw-c255="">
                        <mat-card _ngcontent-hdw-c255="" class="mat-card mat-focus-indicator container">
                           <div _ngcontent-hdw-c255="" class="summary">
                              <div _ngcontent-hdw-c255="" class="subtitle-1">Sepet Özeti</div>
                              <div _ngcontent-hdw-c255="" class="mat-body-2 text-color-grey text-align-right">2 Ürün</div>
                              <div _ngcontent-hdw-c255="" class="summary-content mat-body-2">
                                 <p _ngcontent-hdw-c255="">Toplam Tutar</p>
                                 <p _ngcontent-hdw-c255="">6.668,90 TL</p>
                                 <div _ngcontent-hdw-c255="" class="delivery-price ng-star-inserted">
                                    <p _ngcontent-hdw-c255="">Teslimat Tutarı</p>
                                    <p _ngcontent-hdw-c255="" class="price">
                                       <span _ngcontent-hdw-c255="" class="text-linethrough">26,99 <span _ngcontent-hdw-c255="" class="currency">TL</span></span><!----><span _ngcontent-hdw-c255="" class="font-weight-bolder text-color-success free ng-star-inserted">Ücretsiz</span><!----><!---->
                                    </p>
                                 </div>
                                 <!---->
                                 <div _ngcontent-hdw-c255="" class="discounts">
                                    <p _ngcontent-hdw-c255="" class="ng-star-inserted">Migros İndirimi</p>
                                    <p _ngcontent-hdw-c255="" class="ng-star-inserted">-630,00 TL</p>
                                    <!----><!----><!----><!----><!----><!----><!----><!---->
                                 </div>
                              </div>
                              <div _ngcontent-hdw-c255="" class="subtitle-1">Ödenecek Tutar</div>
                              <div _ngcontent-hdw-c255="" class="subtitle-1 text-align-right">6.038,90 TL</div>
                           </div>
                           <mat-divider _ngcontent-hdw-c255="" role="separator" class="mat-divider mat-divider-horizontal" aria-orientation="horizontal"></mat-divider>
                           <!---->
                  ...
                  <div class="side-container mdc-layout-grid__cell--span-4 mdc-layout-grid__cell--span-3-tablet ng-star-inserted">
                     <fe-line-checkout-summary _nghost-hdw-c258="">
                        <div _ngcontent-hdw-c258="" class="mobile-only">
                           <fe-line-checkout-summary-mobile _ngcontent-hdw-c258="">
                        ...
                        <div _ngcontent-hdw-c258="" class="desktop-only">
                           <fe-line-checkout-summary-desktop _ngcontent-hdw-c258="" _nghost-hdw-c256="">
                              <fe-line-checkout-price-summary _ngcontent-hdw-c256="" _nghost-hdw-c255="">
                                 <mat-card _ngcontent-hdw-c255="" class="mat-card mat-focus-indicator container">
                                    <div _ngcontent-hdw-c255="" class="summary">
                                       <div _ngcontent-hdw-c255="" class="subtitle-1">Sepet Özeti</div>
                                       <div _ngcontent-hdw-c255="" class="mat-body-2 text-color-grey text-align-right">2 Ürün</div>
                                    ...
                                    <!---->
                                    <mat-divider _ngcontent-hdw-c256="" role="separator" class="mat-divider mat-divider-horizontal" aria-orientation="horizontal"></mat-divider>
                                    <button _ngcontent-hdw-c256="" id="checkout-summary-desktop-confirm-button" mat-flat-button="" color="primary" feappclickthrottle="" class="confirm-button mdc-button mdc-button--unelevated mat-mdc-unelevated-button mat-primary mat-mdc-button-base"><span class="mat-mdc-button-persistent-ripple mdc-button__ripple"></span><span class="mdc-button__label"> Devam Et </span><span class="mat-mdc-focus-indicator"></span><span matripple="" class="mat-ripple mat-mdc-button-ripple"></span><span class="mat-mdc-button-touch-target"></span></button>
                                 </mat-card>
                              </fe-line-checkout-price-summary>
                     ...
                     <!---->
                     <sm-add-delivery-note class="desktop-only ng-star-inserted" _nghost-hdw-c496="">
                        <div _ngcontent-hdw-c496="" class="delivery-note-wrapper">
                           <div _ngcontent-hdw-c496="" class="icon-text">
                              <fa-icon _ngcontent-hdw-c496="" class="ng-fa-icon">
                                 <svg role="img" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pen-to-square" class="svg-inline--fa fa-pen-to-square" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                     ...
                     <!---->
                     <fe-card-provision-info class="desktop-only ng-star-inserted" _nghost-hdw-c323="">
                        <div _ngcontent-hdw-c323="" class="container ng-star-inserted">
                           <div _ngcontent-hdw-c323="" class="subtitle-2 text-color-info header">
                              <fa-icon _ngcontent-hdw-c323="" class="ng-fa-icon header--icon">
                                 <svg role="img" aria-hidden="true" focusable="false" data-prefix="far" data-icon="circle-info" class="svg-inline--fa fa-circle-info" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
