               ...
               <div _ngcontent-tus-c500="" class="padding">
                  ...
                  <sm-login _nghost-tus-c502="" class="ng-star-inserted">
                     <div _ngcontent-tus-c502="" class="login ng-star-inserted">
                        ...
                        <div _ngcontent-tus-c502="" class="login__links"><a _ngcontent-tus-c502="" id="login__redirect-to-recovery" routerlink="/sifremi-unuttum" class="mat-caption text-color-grey" ngx-ql="" href="/sifremi-unuttum">Giriş Yapamıyorum</a><a _ngcontent-tus-c502="" id="login__open-otp-faqs-button" href="/sss" class="mat-caption text-color-grey"> Sıkça Sorulan Sorular </a></div>
                     </div>
                     <!----><!---->
                  </sm-login>
                  <!---->
